// scripts/seedFirestoreAdmin.mjs
// Kjør: node scripts/seedFirestoreAdmin.mjs
import { readFileSync } from 'fs';
import { initializeApp, cert } from 'firebase-admin/app';
import { getFirestore } from 'firebase-admin/firestore';

// Les service account fra admin/
const serviceAccount = JSON.parse(
  readFileSync(new URL('../admin/quizino-e59e3-firebase-adminsdk-fbsvc-8118eeb2e9.json', import.meta.url))
);

// Init Admin SDK (omgår Firestore-regler)
...
async function seedDatabase() {
  console.log('🌱 Starter seeding med Admin SDK…');
  ...
  console.log('✅ Ferdig! Firestore er seeded med Admin SDK.');
}
